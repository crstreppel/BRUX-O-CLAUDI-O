...
module.exports = {
  async cadastrarUsuario(req, res) {
    try {
      ...
      await Usuario.create({ usuario, email: emailNorm, senhaHash, emailVerificado: false, emailToken, emailCodigo, emailTokenExpiraEm, emailCodigoTentativas: 0, statusId: null, ativo: true });
